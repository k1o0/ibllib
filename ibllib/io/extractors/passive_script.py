...
for ii, eid in enumerate(eids):
    # more frame2ttl than expected
    if eid in ['e535fb62-e245-4a48-b119-88ce62a6fe67', 'ae384fe2-fa03-4366-a107-69b341b7368a']:
        continue
    # 4 spaces instead of 3
    elif eid == '90e74228-fd1a-482f-bd56-05dbad132861':
        continue
    # no bpod sync pulses
    elif eid == '9931191e-8056-4adc-a410-a4a93487423f':
        continue
    # pearson sync issue
    elif eid == ['6668c4a0-70a4-4012-a7da-709660971d7a', 'e5c772cd-9c92-47ab-9525-d618b66a9b5d']:
        continue
